package com.example.projektpp.config;

import com.example.projektpp.Serwisy.UserServiceImpl;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/register","/login","/registeradd","/error","/uploadFile","/upload","/index").permitAll()
